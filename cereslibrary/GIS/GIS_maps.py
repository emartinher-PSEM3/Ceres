...
#    plt.savefig('NARS_NLA_FINAL_P.pdf')
    plt.savefig("./../static/images/NARS_NLA_FINAL_P.png", bbox_inches='tight', pad_inches=0.1)
...
#    plt.savefig('NARS_NLA_FINAL_N.pdf')
    plt.savefig("./../static/images/NARS_NLA_FINAL_N.png", bbox_inches='tight', pad_inches=0.1)
